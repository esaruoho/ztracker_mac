...
class UserInterfaceElement {
    ...
    public:
        ...
        virtual void draw(ZTDrawable *S, int active)=0;
...
class Frame : public UserInterfaceElement {
    public:
        ...
        ~Frame();
        int update();
        void draw(ZTDrawable *S, int active);
};
...
class PatternDisplay : public UserInterfaceElement {
    ...
    public:
        ...
        int next_order(void);
        void disp_playing_row(int x,int y, int pattern, int row, ZTDrawable *S, TColor bg);
        void update_frame(void);
        void disp_playing_pattern(ZTDrawable *S);
        char* printNote(char *str, event *r);
        void disp_track_headers(ZTDrawable *S);
...
//        int sorted;
        ...
        virtual int update();
        virtual void draw(ZTDrawable *S, int active);
