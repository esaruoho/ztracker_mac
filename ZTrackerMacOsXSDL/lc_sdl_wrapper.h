...
class ZTDrawable {
    public:
        ...
        ZTDrawable(int w = 640, int h = 480, bool free_surface = true);

        ZTDrawable(SDL_Surface *target_surface, 
        ...
        void release(void);
        void Release(void);
        long copy(ZTDrawable* Source, int x, int y,
...
typedef ZTDrawable Bitmap;
typedef ZTDrawable ZTScreen;
